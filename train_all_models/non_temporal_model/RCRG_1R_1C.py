...
def create_model():
    ...
    return RCRG_1R_1C(person_model, num_classes=NUM_CLASSES)
...
def main():
    ...
    print("Loading RCRG_1R_1C Configuration...")
    ...
    training_config = TrainingConfig(
        ...
        checkpoint_dir=f"{KAGGLE_OUTPUT}/checkpoints/RCRG_1R_1C" if IS_KAGGLE else config.training.group_activity.checkpoint_dir,
        log_dir=f"{KAGGLE_OUTPUT}/results/RCRG_1R_1C" if IS_KAGGLE else "reslutes_and_logs/non_temporal_model",
