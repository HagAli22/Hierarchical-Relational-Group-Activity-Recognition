...
RCRG-2R-11C Model
====================
Relational model with 2 Relational layers (2R) and 1 Clique of all 11 people (11C).
"""
...
class RCRG_2R_11C(nn.Module):
    ...
    def forward(self, x):  # x: (B, 12, 1, c, h, w)
        ...
        # ============ Scene-level pooling ============
        rel_features2 = rel_features2.permute(0, 2, 1)  # (B, 128, 12)
        team1 = rel_features2[:, :, :6]  # (B, 128, 6)
        team2 = rel_features2[:, :, 6:]  # (B, 128, 6)
